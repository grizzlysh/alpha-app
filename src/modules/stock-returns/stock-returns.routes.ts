...
router.patch('/:stock_return_uuid/reject', requirePermission(PERMISSIONS.STOCK_RETURN_UPDATE), validateBody(rejectStockReturnSchema), StockReturnController.rejectStockReturn)
