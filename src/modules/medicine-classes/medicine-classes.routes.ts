...
router.get(
  '/',
  requirePermission(PERMISSIONS.MEDICINE_CLASSES_READ),
...
router.get(
  '/dropdown',
  requirePermission(PERMISSIONS.MEDICINE_CLASSES_READ),
  MedicineClassController.getMedicineClassesDropdown
)
...
router.put(
  '/:medicine_class_uuid',
  requirePermission(PERMISSIONS.MEDICINE_CLASSES_UPDATE),
